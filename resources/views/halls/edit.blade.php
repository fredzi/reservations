...
<div class="box box-info">
    ...
    <div class="box-body text-center">
        ...
        @for($y = 0; $y < ($posy+1) ; $y++)
            @for ($x = 0; $x < ($posx+1) ; $x++)
                @if(isset($seats[$x][$y]))
                    <input type="checkbox" class="check" name="<?= $x . '-' . $y ?>" id="<?= $x . '-' . $y ?>" value='1'>
                    <label for="<?= $x . '-' . $y ?>"><?= $seats[$x][$y] ?></label>
                @else
                    <input type="checkbox" class="checkn" name="<?= $x . '-' . $y ?>" id="<?= $x . '-' . $y ?>" value='2'>
                    <label class="klasa" for="<?= $x . '-' . $y ?>">&nbsp;</label>
                @endif
            @endfor
            <br>
